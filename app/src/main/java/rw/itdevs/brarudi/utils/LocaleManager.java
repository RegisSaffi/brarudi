package rw.itdevs.brarudi.utils;
...
public class LocaleManager {
    ...
    public static final  String LANGUAGE_KIRUNDI = "rn";
    ...
    public String getLanguage() {
        return prefs.getString(LANGUAGE_KEY, LANGUAGE_FRENCH);
    }
